...
class ITCategoryJobsScreen extends StatefulWidget {
  const ITCategoryJobsScreen({super.key});

  @override
  State<ITCategoryJobsScreen> createState() => _ITCategoryJobsScreenState();
}

class _ITCategoryJobsScreenState extends State<ITCategoryJobsScreen> {
                              ...
                              child: Column(
                                children: [
                                                  ...
                                                  child: Container( 
                                                    ...
                                                    child: Column(
                                                      children: [
                                                        Center(
                                                          child: Container(
                                                            child: Center(
                                                              child: Text(posts_IT[index].title,textAlign: TextAlign.center,style: TextStyle(
                                                                fontSize: 25,
                                                      ...
                                                      alignment: Alignment.centerLeft,
                                                      child: Container(
                                                        child: Text("Location: ${posts_IT[index].location}",style: TextStyle(
                                                          fontSize: 18,
                                                    ...
                                                    SizedBox(
                                                        ...
                                                        child: Card(
                                                          ...
                                                          child: Center(
                                                            child: Text("${posts_IT[index].salary} Per Month/Year", style: TextStyle(
                                                              fontSize: 16.5,
                                                              fontWeight: FontWeight.bold
                                                            ),),
                                                          ),
                                                       ...
                                                       Container(
                                                        child: Row(
                                                          children: [
                                                            ...
                                                            Container(
                                                              child: Text(posts_IT[index].experience, style: TextStyle(
                                                                fontSize: 20,
                                                      ...
                                                      Container(
                                                        child: Row(
                                                          children: [
                                                            ...
                                                            Container(
                                                              child: Text("#${posts_IT[index].id}", style: TextStyle(
                                                                fontSize: 20,
                                                      ...
                                                      Align(
                                                        ...
                                                        child: Container(
                                                          child: Row(
                                                            ...
                                                            child: Text(posts_IT[index].department, textAlign: TextAlign.left,style: TextStyle(
                                                              fontSize: 20
                                                            ),),
                                                          ),
                                                        ),
                                  ...
                                  Align(
                                    alignment: Alignment.centerLeft,
                                    child: Container(
                                      child: Text("${posts_IT[index].gender} Only",style: TextStyle(
                                        fontSize: 18,
                                        fontWeight: FontWeight.bold
                                      ),),
                                    ),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
       appBar: AppBar(
        ...
        title: Text("Information Technology", style: TextStyle(
          fontSize: 25,
          fontWeight: FontWeight.bold,
